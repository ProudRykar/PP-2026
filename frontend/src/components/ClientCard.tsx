...
export function ClientCard({ channel, senderId, onClose }: ClientCardProps) {
  ...
  if (!client) {
    return (
      <div className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm">
        <p className="text-sm text-gray-400">Профиль не найден</p>
      </div>
    )
  }
  ...
  return (
    <div className="rounded-lg border border-gray-200 bg-white shadow-sm">
      <div className="flex items-center justify-between border-b border-gray-100 px-4 py-3">
        <h3 className="text-sm font-semibold text-gray-700">Карточка клиента</h3>
      ...
      <div className="p-4">
        ...
        <div className="mb-3 space-y-1.5">
          <div className="flex items-center gap-2 text-xs text-gray-600">
            <span className="w-16 shrink-0 text-gray-400">Телефон</span>
            {editing ? (
              <input
        ...
        <div className="mb-2">
          <p className="mb-1 text-xs font-medium text-gray-500">Каналы связи</p>
